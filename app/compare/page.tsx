...
import { Scale, Star, ShieldCheck, Zap, ExternalLink, ArrowUpDown } from 'lucide-react';
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-400">Taxes & shipping dynamically calculated</span>
          </div>
